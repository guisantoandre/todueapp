...
export default async function LoginPage() {
   ...
   return (
      <main className="w-[500px] my-10 px-3">
         <h1 className="text-3xl font-semibold mb-10 text-center">Log in</h1>
         <Link
            href={"/"}
         ...
         <p className="text-sm grid grid-cols-[auto_1fr] gap-x-2 p-5 bg-bg-add-form text-neutral-400 rounded mb-5">
